            ...
            <div class="input-row">
                <div class="input-container">
                    <select name="level" required>
                        <option value="" disabled <?= !isset($level) ? 'selected' : '' ?>>Niveau</option>
                        <option value="1" <?= (isset($level) && $level == '1') ? 'selected' : '' ?>>Débutant</option>
                        <option value="2" <?= (isset($level) && $level == '2') ? 'selected' : '' ?>>Intermédiaire</option>
                        <option value="3" <?= (isset($level) && $level == '3') ? 'selected' : '' ?>>Avancé</option>
                    </select>
                </div>
                <div class="input-container">
