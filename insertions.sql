...
-- Valide
INSERT INTO PERSONNE (id_p, nom, prenom, adresse, telephone, email, experience, salaire, poids, cotisation, date_inscription, niveau)
VALUES (2, 'Martin', 'Bob', '456 Rue de Lyon', '0105060708', 'bob@example.com', 'Intermédiaire', NULL, 15.0, NULL, '2023-11-01', 3);
...
INSERT INTO COURS_PROGRAMME (nom_cours, niveau, duree, heure, jour, Ddd, Ddf, nb_personnes_max)
VALUES ('Cours de saut', 6, 1, '10:00:00', 'Lundi', '2024-11-21', '2024-12-21', 5);

-- Test inserting invalid data for duree (should fail)
INSERT INTO COURS_PROGRAMME (nom_cours, niveau, duree, heure, jour, Ddd, Ddf, nb_personnes_max)
VALUES ('Cours de saut', 3, 3, '10:00:00', 'Lundi', '2024-11-21', '2024-12-21', 5);

-- Test inserting invalid data for heure (should fail)
INSERT INTO COURS_PROGRAMME (nom_cours, niveau, duree, heure, jour, Ddd, Ddf, nb_personnes_max)
VALUES ('Cours de saut', 3, 1, '25:00:00', 'Lundi', '2024-11-21', '2024-12-21', 5);

-- Test inserting invalid data for jour (should fail)
INSERT INTO COURS_PROGRAMME (nom_cours, niveau, duree, heure, jour, Ddd, Ddf, nb_personnes_max)
VALUES ('Cours de saut', 3, 1, '10:00:00', 'Funday', '2024-11-21', '2024-12-21', 5);

-- Test inserting invalid data for nb_personnes_max (should fail)
INSERT INTO COURS_PROGRAMME (nom_cours, niveau, duree, heure, jour, Ddd, Ddf, nb_personnes_max)
VALUES ('Cours de saut', 3, 1, '10:00:00', 'Lundi', '2024-11-21', '2024-12-21', 15);


-- Insertion dans COURS_PROGRAMME
INSERT INTO COURS_PROGRAMME (nom_cours, niveau, duree, heure, jour, Ddd, Ddf, nb_personnes_max)
VALUES 
  ('Cours Débutant', 1, 2, '10:00:00', 'Lundi', '2024-01-01', '2024-01-07', 5),  -- valide
  ('Cours Avancé', 4, 1, '14:00:00', 'Mardi', '2024-01-08', '2024-01-14', 3);   -- valide

-- Cas valide
INSERT INTO COURS_PROGRAMME (nom_cours, niveau, duree, heure, jour, Ddd, Ddf, nb_personnes_max)
VALUES ('Cours Expert', 5, 1, '09:00:00', 'Mercredi', '2024-01-15', '2024-01-21', 5);

-- Cas non valide (niveau en dehors de [1,5])
INSERT INTO COURS_PROGRAMME (nom_cours, niveau, duree, heure, jour, Ddd, Ddf, nb_personnes_max)
VALUES ('Cours Invalide', 6, 1, '09:00:00', 'Mercredi', '2024-01-15', '2024-01-21', 5);

-- Cas valide
INSERT INTO RESERVER (id_personne, id_poney, id_cours, dateR)
VALUES (2, 1, 1, '2024-01-01 10:00:00');

-- Cas non valide (poids de la personne supérieur au poids max du poney)
INSERT INTO RESERVER (id_personne, id_poney, id_cours, dateR)
...
-- Cas non valide (le poney a travaillé trop d'heures sans repos)
INSERT INTO RESERVER (id_personne, id_poney, id_cours, dateR)
...
-- Cas non valide (dépassement du nb_personnes_max)
INSERT INTO RESERVER (id_personne, id_poney, id_cours, dateR)
